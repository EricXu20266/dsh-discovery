...
export const zh = {
  ...
  aiSummaryToggle: 'AI 生态摘要',
  aiSummaryDesc: '向 AI 注入社区插件生态摘要（每次对话消耗少量 token）',
...
export const en = {
  ...
  aiSummaryToggle: 'AI ecosystem summary',
  aiSummaryDesc: 'Inject the community plugin ecosystem summary into the AI (costs a few tokens per conversation)',
